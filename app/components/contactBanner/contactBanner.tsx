export default function ContactBanner() {
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 background-accent text-white flex items-center justify-center gap-6 px-4 py-1 text-sm portrait:flex landscape:hidden whitespace-nowrap overflow-hidden text-ellipsis">
      {/* Phone SVG */}
      ...
      <span className="flex items-center gap-1">
        ...
        <a href="mailto:predivinetutoring@gmail.com">
